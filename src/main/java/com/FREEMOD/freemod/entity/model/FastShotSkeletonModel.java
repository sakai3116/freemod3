...
public class FastShotSkeletonModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(FreeMod.MOD_ID,"fast_shot_skeleton"),"main");
	...
	public FastShotSkeletonModel(ModelPart root) {
